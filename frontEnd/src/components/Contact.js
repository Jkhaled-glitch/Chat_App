      ...
      <Stack sx={{height:'100%'}}>
        ...
        spacing={3}>
          <Stack alignItems={'center'} direction='row' spacing={2}>
            <Avatar alt={"islem"} sx={{height:64, width:64}}/>
            <Stack spacing={0.5}>
          ...
          <Stack direction='row' spacing={2} alignItems={'center'}>
            {[1,2,3].map((el)=>(
              <Box>
                <img src={faker.image.business()} alt={"Iware community"}/>
              </Box>
            ))}
          </Stack>
          <Divider/>
          ...
          <Stack direction='row' spacing={2} alignItems={'center'}>
            <Avatar  alt={"islem"}/>
            <Stack spacing={0.5}>
              <Typography variant='subtitle2' >Iware community</Typography>
              <Typography variant='caption' >Asma, bilel, sedki, You</Typography>
            </Stack>
          </Stack>
